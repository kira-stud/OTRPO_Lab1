html_template = """<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //RU" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
table, td {{ color: #000000; }} #u_body a {{ color: #0000ee; text-decoration: underline; }} @media (max-width: 480px) {{ #u_content_image_1 .v-src-width {{ width: auto !important; }} #u_content_image_1 .v-src-max-width {{ max-width: 55% !important; }} #u_content_image_2 .v-src-width {{ width: auto !important; }} #u_content_image_2 .v-src-max-width {{ max-width: 60% !important; }} #u_content_text_1 .v-container-padding-padding {{ padding: 30px 30px 30px 20px !important; }} #u_content_text_5 .v-text-align {{ text-align: center !important; }} #u_content_text_6 .v-text-align {{ text-align: center !important; }} }}
    </style>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/pokemon-icon.png" alt="Покемон" title="Покемон" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 30%;max-width: 159px;" width="159" class="v-src-width v-src-max-width"/>
...
<table id="u_content_text_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align" style="font-size: 14px; color: #333333; line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-family: 'Crimson Text', serif; font-size: 14px; line-height: 19.6px;"><strong><span style="font-size: 22px; line-height: 30.8px;">Привет!</span></strong></span></p>
<p style="font-size: 14px; line-height: 140%;"> </p>
<p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; font-family: 'Crimson Text', serif;"></strong>Держи результаты своего боя:</strong></span></p>
<p style="font-size: 14px; line-height: 140%;"> </p>
<p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; font-family: 'Crimson Text', serif;">Дата и время: {0}</span></p>
<p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; font-family: 'Crimson Text', serif;">Твой покемон: {1}</span></p>
<p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; font-family: 'Crimson Text', serif;">Покемон бота: {2}</span></p>
<p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; font-family: 'Crimson Text', serif;">Победитель: {3}</span></p>
<p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; font-family: 'Crimson Text', serif;">Число раундов: {4}</span></p>
  </div>
...
<table id="u_content_text_5" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align" style="font-size: 14px; color: #34495e; line-height: 180%; text-align: left; word-wrap: break-word;">
    <p style="line-height: 180%; text-align: left;"><span style="font-family: 'Crimson Text', serif; line-height: 25.2px;"><span style="font-size: 18px; line-height: 32.4px;">Сайт без названия</span></span></p>
  </div>
...
<table id="u_content_text_6" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align" style="font-size: 14px; color: #34495e; line-height: 180%; text-align: left; word-wrap: break-word;">
    <p style="line-height: 180%; text-align: left;"><span style="font-family: 'Crimson Text', serif; line-height: 25.2px;"><span style="font-size: 18px; line-height: 32.4px;">@ 2023 Все права защищены</span></span></p>
  </div>
